...
export const MarkdownEditor = () => {
  return (
    <MDXEditor
      ...
      plugins={[headingsPlugin(), listsPlugin(), quotePlugin(), markdownShortcutPlugin()]} // Prevede l'uso di plugin per inserire solo quelli che ci servono ed evitare bundle-size troppo grandi
